...
if [ $SPRINGLOADEDADAPTER_DISABLE = true ]; then
	 ...
	 java -Djava.security.egd=file:/dev/./urandom $JAVA_OPTS -cp /app/ -javaagent:/springloaded-1.2.5.RELEASE.jar -noverify org.springframework.boot.loader.JarLauncher	
fi